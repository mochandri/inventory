...
class BarangKeluar extends CI_Controller
{
	...
	public function tambah()
	{
		...
		$data['jmlCabang'] = $this->cabang_model->data()->num_rows();
	...
	public function tambah_cabang(){
		...
		$kode['cb'] = $this->barangKeluar_model->get_cabang();
		$data['title'] = 'Pilih Cabang';
		

		$this->load->view('templates/header', $data);
		$this->load->view('barangKeluar/pilih_cabang', $kode);
		$this->load->view('templates/footer');
	...
	public function form(){
		...
		$data = [
			'kode' => $this->barangKeluar_model->auto_code($a),
			'in' => $this->barangKeluar_model->get_inisial($a),
		];
		$this->load->view('barangKeluar/tambah_barang', $data);
	}
