...
class barangKeluar_model extends ci_model
{
  ...
  public function dataJoin()
  {
    ...
    $this->db->join('cabang as c', 'c.id_cabang = bk.id_cabang');
  ...
  public function buat_kode()
  {
    ...
    $kodejadi = "20" . $year . "-" . $month . "-BRG-K-" . $kodemax;    // hasilnya 
    return $kodejadi;
  }
  ...
  public function auto_code($a){
		$query = $this->db->query("SELECT MAX(id_barang_keluar) as max_code FROM barang_keluar WHERE cabang='$a'");
