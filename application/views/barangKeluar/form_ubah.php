<?php foreach ($data as $d) : ?>
    ...
    <div class="container-fluid">
        ...
        <form action="<?= base_url() ?>barangKeluar/proses_ubah" name="myFormUpdate" method="POST" enctype="multipart/form-data" onsubmit="return validateFormUpdate()">
                        ...
                        <div class="card-body">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group"><label>ID Barang Keluar</label>
                                    <input class="form-control" name="idbk" value="<?= $d->id_barang_keluar ?>" type="text" placeholder="" autocomplete="off" readonly>
                                </div>

                                <!-- Barang -->
                                <div class="form-group"><label>Nama Barang</label>
                                    <input name="barang" type="hidden" value="<?= $d->id_barang ?>">
                                    <input class="form-control" name="preview" type="text" value="<?= $d->nama_barang ?>" autocomplete="off" readonly>
                                </div>
                                ...
                                <div class="form-group"><label>Tanggal Keluar</label>
                                    <input class="form-control" name="tgl" id="datepicker" value="<?= format($d->tgl_keluar) ?>" type="text" placeholder="" autocomplete="off">
                                </div>
                                ...
                                <div class="form-group"><label>Lokasi</label>
                                    <input name="lokasi" type="hidden" value="<?= $d->lokasi ?>">
                                    <input class="form-control" name="jmlkeluar" type="text" value="<?= $d->lokasi ?>">
                                </div>


                                <!-- Jumlah Barang -->
                                <div class="form-group"><label>Jumlah Keluar</label>
                                    <input name="jmlkeluar" type="hidden" value="<?= $d->jumlah_keluar ?>">
                                    <input class="form-control" name="jmlkeluar" type="number" value="<?= $d->jumlah_keluar ?>">
                                </div>
                    ...
                    <div class="card border-bottom-secondary shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="col-lg-12">
                                ...
                                <center>
                                    <img id="preview" width="200px" src="<?= base_url() ?>assets/upload/barang/<?= $d->foto ?>" alt="">
                                </center>
