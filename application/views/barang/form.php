...
$kd = $tgl . "INV" . $b . sprintf("%04s", $kodemax);
// var_dump($kd);
// die;
                    ...
                    <div class="card-body">
                        <div class="col-lg-12">
                            ...
                            <div class="form-group"><label>Kode Asset</label>
                                <input class="form-control" name="id" value="<?= $kd ?>" type="text" placeholder="" autocomplete="off" readonly>
                            </div>
                            <!-- Nama Barang -->
                            <div class="form-group"><label>Nama Asset</label>
                                <input class="form-control" name="barang" type="text" placeholder="">
                            </div>

                            <div class="form-group"><label>Tanggal Beli</label>
                                <input class="form-control" name="tgl" id="datepicker" value="<?= $tanggal ?>" type="text" placeholder="" autocomplete="off" readonly>
                            </div>

                            <!-- opsi cabang -->
                            <div class="form-group"><label>Cabang</label>
                                <input class="form-control" name="cabang" id="" value="<?= $d ?>" type="text" placeholder="" autocomplete="off" readonly>
                            </div>
